              ...
              >
                ...
                <div className="relative flex h-full flex-col justify-between">
                  <div className="flex items-center justify-between">
                    <span className="grid h-10 w-10 place-items-center rounded-xl border border-white/10 bg-white/[.035] text-[#70d7ff] transition-all duration-500 group-hover:border-[#4b72ff]/45 group-hover:bg-[#111529] group-hover:text-[#c8efff]">
